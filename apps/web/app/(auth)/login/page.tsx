  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-nexus-bg px-4">
      <div className="w-full max-w-sm">
        ...
        <p className="mb-8 text-center text-sm text-nexus-muted">Sign in to your account</p>

        <button
          onClick={handleGoogleLogin}
          className="mb-4 flex w-full items-center justify-center gap-2 rounded-xl border border-nexus-border bg-nexus-surface px-4 py-3 text-sm font-medium text-nexus-text transition-colors hover:border-nexus-accent"
        >
        ...
        <form onSubmit={handleLogin} className="space-y-3">
          ...
          <input type="password" placeholder="Password" value={password} onChange={e => setPassword(e.target.value)} required className="w-full rounded-xl border border-nexus-border bg-nexus-surface px-4 py-3 text-sm text-nexus-text placeholder:text-nexus-muted focus:border-nexus-accent focus:outline-none" />
        ...
        <p className="mt-6 text-center text-xs text-nexus-muted">
          ...
          <Link href="/signup" className="text-nexus-accent hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
